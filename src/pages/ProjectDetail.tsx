            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="bg-gray-800 p-0">
                <textarea
                  ...
                  className="w-full bg-gray-800 text-gray-100 font-mono text-sm leading-relaxed p-6 resize-y min-h-[300px] focus:outline-none focus:ring-2 focus:ring-purple-500/50"
                  spellCheck={false}
                  placeholder="# 在这里修改和练习Python代码..."
                />
              </div>
